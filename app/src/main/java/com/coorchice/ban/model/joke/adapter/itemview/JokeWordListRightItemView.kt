 ...
 * Notes:
 */
class JokeWordListRightItemView(context: Context) : RelativeLayout(context) {

    init {
        LayoutInflater.from(context).inflate(R.layout.item_view_joke_word_list_right, this, true)
        initView()
    }
